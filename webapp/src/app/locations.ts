...
export function makeDemoLocations() {
  return [
    ...
    new DemoLocation(
      ...
      [-12.9227111,-69.9724235], 12,
      [0.0, -56.15, -16.73619187839766, -73.125],
    ),

    new DemoLocation(
      'Rondônia', 'Brazil',
      [-9.708591,-64.3064042], 9,
      [0.0, -56.15, -16.73619187839766, -73.125],
    ),

    new DemoLocation(
      'Lagos', 'Nigeria',
      [6.7369913,3.8314242], 10,
      [11.178401873711781, 5.725, 5.515985819155334, 0.0],
    ),

    new DemoLocation(
      'Lake Urmia دریاچه ارومیه', 'Iran',
      [37.54009,45.94244], 10,
      [40.97989806962013, 50.725, 31.852162238024967, 39.375],
    ),

    new DemoLocation(
      'United States', '',
      [38.8713334,-98.6173605], 3,
    ...
    // new DemoLocation(
    //   'Giza الجيزة', 'Al Omraneyah, Egypt',
    //   [30.0265822,31.2736007], 11,
    //   [31.952162238024968, 33.85, 26.959125784374052, 28.125],
    // ),
